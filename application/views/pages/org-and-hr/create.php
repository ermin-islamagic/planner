            ...
            <div class="col-lg-12">
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <!-- Select Basic -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="department">Departments</label>
                            <div class="col-md-8">
                        ...
                        <!-- File Button -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="tor">TOR</label>
                            <div class="col-md-4">
                        ...
                        <!-- File Button -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="kpi">Goals &amp; KPI</label>
                            <div class="col-md-4">
